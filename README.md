...
To commence pre-training with 2D Medical Scans, split the data into `train`, `val`, `test` sets. Create three folders named `train`, `val`, `test`, and move the scans accordingly.
