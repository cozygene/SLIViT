...
class TrainOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--meta_csv', type=str,  default='./Dsets/kermany_meta_mock3.csv',help='Path to meta csv file')
        ...
        parser.add_argument('--b_size', type=int ,default=1, help='Batch size for training')
