...
import pandas as pd
import os
from utils.load_backbone import ConvNext
...
if __name__ == '__main__':
    ...
    if opt.dataset == 'kermany':
        ...
        model = AutoModelForImageClassification.from_pretrained("facebook/convnext-tiny-224",return_dict=False,num_labels=14,
                                                            ignore_mismatched_sizes=True)
    else:
        ...
        model= AutoModelForImageClassification.from_pretrained("facebook/convnext-tiny-224",return_dict=False,num_labels=len(opt.pathologies.split(',')),
                                                            ignore_mismatched_sizes=True)
